...
class NautobotAppPowerPlantExampleModelAPIViewTest(APIViewTestCases.APIViewTestCase):
    # pylint: disable=too-many-ancestors
    """Test the API viewsets for NautobotAppPowerPlantExampleModel."""
    ...
    def setUpTestData(cls):
        """Create test data for NautobotAppPowerPlantExampleModel API viewset."""
        super().setUpTestData()
